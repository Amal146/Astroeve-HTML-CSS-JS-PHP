...
<div class="heading"style="background-image : url('/projet/astro books/library.jpg'); background-repeat: no-repeat ;background-size:cover ;opacity:0.7 ;">
   <h3 style="color:white">your personal library</h3>
   <p> <a href="home.php">home</a> / personal library </p>
</div>

<section class="books" >

   <h1 class="title">favorit books</h1>

   <div class="box-container" >
   <?php  
         $select_books = mysqli_query($conn, "SELECT * FROM `library`JOIN `personal_library` ON `library`.book_id = `personal_library`.book_id WHERE `personal_library`.Member_id = '$member_id'") or die('query failed');
