...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select_members) > 0){
      ...
      if($pass != $cpass){
         ...
         mysqli_query($conn, "INSERT INTO `account`(first_name,Last_name,country,phone,birthday,email_adresse,password) VALUES('$fname','$lname','$country','$phone','$birthday', '$email', '$cpass')") or die('query failed');
...
<div class="form-container"style=" background-image : url('/projet/bklogin.jpg'); background-repeat: no-repeat ;background-size: cover; ">
   ...
   <form action="" method="post">
      ...
      <input type="date" name="birthday" placeholder="enter your birthday date" required class="box" >
      <select  type="text" name="country" placeholder="enter your country" required class="box" >
